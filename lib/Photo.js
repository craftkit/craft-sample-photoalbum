...
Demo.Album.Photo = class Photo extends Craft.Widget.NavigationGroup.Page {
	...
	viewDidLoad(callback){
		...
		this.comments = new Demo.Album.CommentList({
		...
		Demo.Album.Tools.ajax("/data/"+this.photoId+".json",(data) => {
			...
			let actionPanelContent = new Demo.Album.LicensePanel({
