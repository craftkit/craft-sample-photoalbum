...
Demo.Album.Wall = class Wall extends Craft.Widget.NavigationGroup.Page {
	...
	viewDidLoad(callback){
		...
		this.actionBtn = new Demo.Album.ActionButton({
			iconSource : 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css',
	...
	load(callback){
		Demo.Album.Tools.ajax("/data/list.json",(data) => {
	...
	openPhoto(id){
		let component = new Demo.Album.Photo({
			photoId : id,
		});
